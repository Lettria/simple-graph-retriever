...
```bash
pip install simple_graph_retriever[neo4j]==1.0.0-rc.18
```

**Install with FalkorDB support:**

```bash
pip install simple_graph_retriever[falkordb]==1.0.0-rc.18
```

**Install with support for both:**

```bash
pip install simple_graph_retriever[all]==1.0.0-rc.18
```
